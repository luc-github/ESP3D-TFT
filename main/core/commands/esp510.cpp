...
void Esp3DCommands::ESP510(int cmd_params_pos,esp3d_msg_t * msg)
{
    ...
    if (tmpstr.length()==0) {
        ...
        esp3d_log("got %s param for a value of %d, is valid %d", tmpstr.c_str(),byteValue, esp3dTFTsettings.isValidByteSetting(byteValue, esp3d_session_timeout));
