...
void sta_screen() {
  ...
  lv_obj_add_event_cb(btnback, event_button_sta_back_handler, LV_EVENT_PRESSED,
                      NULL);
  ...
  lv_obj_add_event_cb(btn, sta_event_button_ok_handler, LV_EVENT_PRESSED, NULL);
  ...
  lv_obj_add_event_cb(btn2, sta_event_button_search_handler, LV_EVENT_PRESSED,
                      NULL);
