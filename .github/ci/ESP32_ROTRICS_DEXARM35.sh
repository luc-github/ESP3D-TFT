...
sed -i 's/OPTION(ESP32_ROTRICS_DEXARM35 "TFT TARGET is ESP32 Rotrics DexArm 3.5inches" OFF/OPTION(ESP32_ROTRICS_DEXARM35 "TFT TARGET is ESP32 Rotrics DexArm 3.5inches" ON/g' ./CMakeLists.txt
...
sed -i 's/ESP32S3_8048S070 "TFT TARGET is ESP32S3 7.0inches" ON/ESP32S3_8048S070 "TFT TARGET is ESP32S3 7.0inches" OFF/g' ./CMakeLists.txt
idf.py fullclean
