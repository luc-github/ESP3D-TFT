...
source ./export.sh
cd $GITHUB_WORKSPACE
sed -i 's/OPTION(ESP32_2432S028R "TFT TARGET is ESP32_2432S028R 2.8inches" OFF/OPTION(ESP32_2432S028R "TFT TARGET is ESP32_2432S028R 2.8inches" ON/g' ./CMakeLists.txt
