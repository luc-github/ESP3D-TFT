 ...
 *
 * This function initializes the TCA9554 component with the provided configuration.
 *
 ...
 */
esp_err_t tca9554_init(i2c_bus_handle_t i2c_bus, const tca9554_config_t *config);

/**
 * @brief Sets the configuration of the TCA9554.
 *
 * This function sets the configuration of the TCA9554 by writing the specified value to the device.
 *
 * @param val The value to be written to the TCA9554.
 * @return `ESP_OK` if the configuration was set successfully, otherwise an error code.
 */
 ...
 *
 * This function sets the values of the output pins on the TCA9554 GPIO expander.
 *
 * @param pin_val The value to be written to the output pins. Each bit in the value corresponds to a pin on the expander.
 *
 * @return
 ...
 *
 * This function reads the current values of the output pins on the TCA9554 GPIO expander
 * and stores the result in the provided pointer `pin_val`.
 *
 * @param[in,out] pin_val Pointer to a variable where the pin values will be stored.
 *                        The variable should have enough memory to store all the pin values.
 *
 * @return
 ...
 *
 * This function reads the current state of the input pins of the TCA9554 GPIO expander
 * and stores the result in the `pin_val` parameter.
 *
 * @param[in,out] pin_val Pointer to a variable where the pin values will be stored.
 *                        The variable should be pre-allocated by the caller.
 *
 ...
 *
 * This function sets the polarity inversion value for the TCA9554 GPIO expander.
 * The polarity inversion determines whether the input signals are inverted or not.
 *
 ...
 *            A value of 0 means no inversion, while a value of 1 means inversion.
 *
 * @return
 *     - ESP_OK: Success
