...
static void disp_spi_add_device_config(spi_host_device_t host,
...
void disp_spi_add_device(spi_host_device_t host,
                         ...
                         disp_spi_flush_cb_t flush_cb) {
  esp3d_log("Adding SPI device");
  esp3d_log("Clock speed: %dHz, mode: %d, CS pin: %d",
            spi_dev_cfg->clock_speed_hz, spi_dev_cfg->mode,
            spi_dev_cfg->spics_io_num);
