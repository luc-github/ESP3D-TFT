 ...
 *      TYPEDEFS
 **********************/
typedef void (*disp_spi_flush_cb_t)(void);
 ...
 * GLOBAL PROTOTYPES
 **********************/
void disp_spi_add_device(spi_host_device_t host, spi_device_interface_config_t *devcfg, disp_spi_flush_cb_t flush_cb);
