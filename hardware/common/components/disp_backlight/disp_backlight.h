...
#ifndef DISP_BACKLIGHT_H
#define DISP_BACKLIGHT_H
 ...
 * GPIO controlled backlight (ON/OFF) is turned off with value 0 and turned on with any positive value.
 *
