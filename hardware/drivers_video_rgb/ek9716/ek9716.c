 ...
 *
 * This function initializes a new ek9716 LCD panel based on the provided
 * configuration.
 *
 * @param disp_panel_cfg Pointer to the configuration structure for the ek9716
 * panel.
 ...
 */
esp_err_t esp_lcd_new_panel_ek9716(
