 ...
 *
 * This function initializes a new ST7262 LCD panel using the provided
 * configuration.
 *
 * @param disp_panel_cfg Pointer to the configuration structure for the ST7262
 * panel.
 * @param disp_panel Pointer to the handle of the initialized ST7262 panel.
 *
 * @return `ESP_OK` if the ST7262 panel is successfully initialized, or an error
