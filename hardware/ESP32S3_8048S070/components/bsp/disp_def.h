...
#define DISP_CLK_FREQ (12 * 1000 * 1000)

#define DISP_PCLK_PIN (42)
#define DISP_VSYNC_PIN (40)
#define DISP_HSYNC_PIN (39)
#define DISP_DE_PIN (41)

#define DISP_D00_PIN (15)  // B0
#define DISP_D01_PIN (7)   // B1
#define DISP_D02_PIN (6)   // B2
#define DISP_D03_PIN (5)   // B3
#define DISP_D04_PIN (4)   // B4
#define DISP_D05_PIN (9)   // G0
#define DISP_D06_PIN (46)  // G1
#define DISP_D07_PIN (3)   // G2
#define DISP_D08_PIN (8)   // G3
#define DISP_D09_PIN (16)  // G4
#define DISP_D10_PIN (1)   // G5
#define DISP_D11_PIN (14)  // R0
#define DISP_D12_PIN (21)  // R1
#define DISP_D13_PIN (47)  // R2
#define DISP_D14_PIN (48)  // R3
#define DISP_D15_PIN (45)  // R4
#define DISP_EN_PIN (-1)   // Not connected

#define DISP_HSYNC_BACK_PORSH (16)
#define DISP_HSYNC_FRONT_PORSH (210)
#define DISP_HSYNC_PULSE_WIDTH (30)
#define DISP_VSYNC_BACK_PORSH (10)
#define DISP_VSYNC_FRONT_PORSH (22)
#define DISP_VSYNC_PULSE_WIDTH (13)
