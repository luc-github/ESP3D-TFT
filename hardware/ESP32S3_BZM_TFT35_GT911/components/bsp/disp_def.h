...
#define DISP_BL_PIN (4)  // GPIO 45
#define DISP_CS_PIN (11)  // GPIO 48
#define DISP_RST_PIN (3)  // GPIO 4 - same as touch
#define DISP_RS_PIN (10)   // GPIO 0
#define DISP_WR_PIN (9)  // GPIO 47

#define DISP_D00_PIN (8)   // GPIO 9
#define DISP_D01_PIN (18)  // GPIO 46
#define DISP_D02_PIN (17)   // GPIO 3
#define DISP_D03_PIN (16)   // GPIO 8
#define DISP_D04_PIN (15)  // GPIO 18
#define DISP_D05_PIN (7)  // GPIO 17
#define DISP_D06_PIN (6)  // GPIO 16
#define DISP_D07_PIN (5)  // GPIO 15
